document.addEventListener('DOMContentLoaded', function() {
    ...
    function initCountdownTimer() {
        ...
        const targetDate = new Date('2026-09-19T09:00:00-05:00').getTime();
            ...
            if (timeLeft > 0) {
                ...
                if (countdownContent) {
                    countdownContent.innerHTML = `
                        <h1 class="countdown-title"> The 2026 Red Stick Rumble is Here!</h1>
                        <div class="event-details">
                            <p class="event-date">September 19th, 2026 • Offseason</p>
                            <p class="event-location"> Denham Springs High School, Denham Springs, LA</p>
                        </div>
                    `;
                }
            }
